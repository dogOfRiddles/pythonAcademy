...
print('Enter a date of birth, please. In the nature of \'10-06-1983\':')
...
print('You entered:', userProbablyNotRealBirthday,
      'which we hope is a date of birth.')
# may there be many days like it

try:
    whereDatesGoToDie = datetime.strptime(
        userProbablyNotRealBirthday, '%m-%d-%Y')
# this, the test. If we have done our part well? There is power in this moment.
    ...
    print('In one hundred years, your birthday will fall on a',
          theSunlitDaySomeday.strftime('%A'), 'in the year',
          theSunlitDaySomeday.year)
